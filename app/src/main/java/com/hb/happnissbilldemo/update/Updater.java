package com.hb.happnissbilldemo.update;
...
import com.hb.happnissbilldemo.activity.UpdateActivity;
...
public class Updater {
    ...
    static private final String APK_FILE_NAME = "HappinessBillDemo.apk";
